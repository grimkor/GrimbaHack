    ...
    public static Dictionary<int, Dictionary<string, string>> Data = new()
    {
        ...
        // COM_RangerSlayer
        {
            5, new()
            {
                ...
                { "COM_RangerSlayer_combat_cn_3_0", "6H" },
        ...
        // S01_Goldar
        {
            7, new()
            {
                ...
                { "S01_Goldar_combat_sup_start_3", "SUPER"}
            }
        },
        // COM_Drakkon
        {
        ...
        // S16_PurpleRanger RJ
        {
            19, new()
            {
                ...
                { "S16_PurpleRanger_combat_sp_ex_1_proj_0", "L+S" },
                { "S16_PurpleRanger_combat_sp_airspec_0_otg", "9S" },
                { "S16_PurpleRanger_combat_sp_1_a_1", "5S4S" },
                { "S16_PurpleRanger_combat_sp_1_b_1", "5S6S" },
        ...
        // SF_RyuRanger
        {
            22, new()
            {
                ...
                { "SF_RyuRanger_combat_sp_2_l_0_b", "623L" },
                { "SF_RyuRanger_combat_sp_2_m_0", "623M" },
                { "SF_RyuRanger_combat_sp_2_m_0_b", "623M" },
                { "SF_RyuRanger_combat_sp_2_h_1", "623H" },
                { "SF_RyuRanger_combat_sp_2_h_0_otg", "" },
                { "SF_RyuRanger_combat_sp_3_l_0", "214L" },
                { "SF_RyuRanger_combat_sp_3_m_0", "214M" },
                { "SF_RyuRanger_combat_sp_3_h_0", "" },
                ...
                { "SF_RyuRanger_combat_sup_start_0_beam_0", "" },
                { "SF_RyuRanger_combat_sup_start_0_beam_1", "L+S" },
                { "SF_RyuRanger_combat_sup_start_0_beam_air_0", "" },
                { "SF_RyuRanger_combat_sup_start_0_beam_air_1", "L+S" }
            }
        },
        // SF_ChunLiRanger
        {
            23, new()
            {
                { "SF_ChunLiRanger_combat_cn_3_0", "5S" },
                { "SF_ChunLiRanger_combat_jump_heavy_1", "H" },
                ...
                { "SF_ChunLiRanger_combat_jump_cn_1_0", "2M" },
                { "SF_ChunLiRanger_combat_jump_cn_1_1", "2M" },
                { "SF_ChunLiRanger_combat_jump_cn_1_2", "2M" },
                { "SF_ChunLiRanger_combat_jump_cn_1_0_otg", "2M" },
                { "SF_ChunLiRanger_combat_cn_1_0", "6M" },
                { "SF_ChunLiRanger_combat_sp_2_air_alt", "H" },
                { "SF_ChunLiRanger_combat_jump_special_0", "9S" }
            }
        },
        {
            // S01_AdamPark
