...
public static class Global
{
    ...
    public static readonly List<Stage> Stages = new()
    {
        ...
        new Stage() { Label = "Command Center Story", Value = "Arena_CCC" , Key = StageSelectOverrideOptions.CommandCenterStory},
